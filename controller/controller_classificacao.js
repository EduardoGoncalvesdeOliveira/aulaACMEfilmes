    ...
    try {
        ...
        if (String(contentType).toLowerCase() == 'application/json') {
            ...
            if (dadosClassificacao.nome == '' || dadosClassificacao.nome == undefined || dadosClassificacao.nome.length > 80 ||
                dadosClassificacao.codigo == '' || dadosClassificacao.codigo == undefined || dadosClassificacao.codigo.length > 65000) {
                dadosClassificacao.descricao == '' || dadosClassificacao.descricao == undefined || dadosClassificacao.descricao.length > 65000 ||
                    dadosClassificacao.foto_classificacao == '' || dadosClassificacao.foto_classificacao == undefined || dadosClassificacao.foto_classificacao.length > 65000
